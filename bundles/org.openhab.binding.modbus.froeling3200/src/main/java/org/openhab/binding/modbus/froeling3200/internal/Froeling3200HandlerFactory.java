...
import static org.openhab.binding.modbus.froeling3200.internal.Froeling3200BindingConstants.THING_TYPE_LAMBDATRONIC_P3200;
...
public class Froeling3200HandlerFactory extends BaseThingHandlerFactory {
    ...
    protected @Nullable ThingHandler createHandler(Thing thing) {
        ...
        if (THING_TYPE_LAMBDATRONIC_P3200.equals(thingTypeUID)) {
            return new Froeling3200Handler(thing);
        }
